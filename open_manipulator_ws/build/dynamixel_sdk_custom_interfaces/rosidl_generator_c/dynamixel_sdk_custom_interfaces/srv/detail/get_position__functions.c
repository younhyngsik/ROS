...
dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__Sequence__init(dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Request)) {
      return false;
    }
  ...
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Request)) {
      return false;
    }
...
dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__Sequence__init(dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Response)) {
      return false;
    }
  ...
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Response)) {
      return false;
    }
    const size_t allocation_size =
...
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__init(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event)) {
      return false;
    }
  ...
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event)) {
      return false;
    }
    const size_t allocation_size =
