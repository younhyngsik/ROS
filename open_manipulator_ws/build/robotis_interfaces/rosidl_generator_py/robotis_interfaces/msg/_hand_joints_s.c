...
bool robotis_interfaces__msg__hand_joints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotis_interfaces.msg._hand_joints.HandJoints", full_classname_dest, 46) == 0);
  }
  robotis_interfaces__msg__HandJoints * ros_message = _ros_message;
  {  // header
  ...
  {  // joints
    ...
    Py_ssize_t size = 21;
    geometry_msgs__msg__Point32 * dest = ros_message->joints;
...
{
  /* NOTE(esteve): Call constructor of HandJoints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotis_interfaces.msg._hand_joints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HandJoints");
