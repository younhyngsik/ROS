...
dynamixel_interfaces__srv__RebootDxl_Request__Sequence__init(dynamixel_interfaces__srv__RebootDxl_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dynamixel_interfaces__srv__RebootDxl_Request)) {
      return false;
    }
  ...
  dynamixel_interfaces__srv__RebootDxl_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dynamixel_interfaces__srv__RebootDxl_Request)) {
      return false;
    }
...
dynamixel_interfaces__srv__RebootDxl_Response__Sequence__init(dynamixel_interfaces__srv__RebootDxl_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dynamixel_interfaces__srv__RebootDxl_Response)) {
      return false;
    }
  ...
  dynamixel_interfaces__srv__RebootDxl_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dynamixel_interfaces__srv__RebootDxl_Response)) {
      return false;
    }
    const size_t allocation_size =
...
dynamixel_interfaces__srv__RebootDxl_Event__Sequence__init(dynamixel_interfaces__srv__RebootDxl_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dynamixel_interfaces__srv__RebootDxl_Event)) {
      return false;
    }
  ...
  dynamixel_interfaces__srv__RebootDxl_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dynamixel_interfaces__srv__RebootDxl_Event)) {
      return false;
    }
    const size_t allocation_size =
