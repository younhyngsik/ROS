...
inline std::string to_yaml(const SetDataToDxl_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use dynamixel_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dynamixel_interfaces::srv::SetDataToDxl_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  dynamixel_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use dynamixel_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const dynamixel_interfaces::srv::SetDataToDxl_Event & msg)
{
  return dynamixel_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dynamixel_interfaces::srv::SetDataToDxl_Event>()
{
  return "dynamixel_interfaces::srv::SetDataToDxl_Event";
}

template<>
inline const char * name<dynamixel_interfaces::srv::SetDataToDxl_Event>()
{
  return "dynamixel_interfaces/srv/SetDataToDxl_Event";
}

template<>
struct has_fixed_size<dynamixel_interfaces::srv::SetDataToDxl_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dynamixel_interfaces::srv::SetDataToDxl_Event>
  : std::integral_constant<bool, has_bounded_size<dynamixel_interfaces::srv::SetDataToDxl_Request>::value && has_bounded_size<dynamixel_interfaces::srv::SetDataToDxl_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<dynamixel_interfaces::srv::SetDataToDxl_Event>
  : std::true_type {};
