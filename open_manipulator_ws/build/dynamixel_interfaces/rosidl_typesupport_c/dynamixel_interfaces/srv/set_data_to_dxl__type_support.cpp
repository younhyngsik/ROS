...
static const _SetDataToDxl_Event_type_support_symbol_names_t _SetDataToDxl_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_interfaces, srv, SetDataToDxl_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_interfaces, srv, SetDataToDxl_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_interfaces, srv, SetDataToDxl_Event)() {
  return &::dynamixel_interfaces::srv::rosidl_typesupport_c::SetDataToDxl_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetDataToDxl_service_type_support_handle = {
  ...
  &SetDataToDxl_Request_message_type_support_handle,
  &SetDataToDxl_Response_message_type_support_handle,
  &SetDataToDxl_Event_message_type_support_handle,
