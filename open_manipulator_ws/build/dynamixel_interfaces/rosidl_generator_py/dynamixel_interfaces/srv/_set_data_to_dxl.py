...
class Metaclass_SetDataToDxl_Event(type):
    """Metaclass of message 'SetDataToDxl_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_data_to_dxl__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_data_to_dxl__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_data_to_dxl__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_data_to_dxl__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_data_to_dxl__event
...
class SetDataToDxl_Event(metaclass=Metaclass_SetDataToDxl_Event):
    """Message class 'SetDataToDxl_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dynamixel_interfaces/SetDataToDxl_Request, 1>',
        'response': 'sequence<dynamixel_interfaces/SetDataToDxl_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dynamixel_interfaces', 'srv'], 'SetDataToDxl_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dynamixel_interfaces', 'srv'], 'SetDataToDxl_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dynamixel_interfaces.srv import SetDataToDxl_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetDataToDxl_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetDataToDxl_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dynamixel_interfaces.srv import SetDataToDxl_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetDataToDxl_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetDataToDxl_Response'"
...
class Metaclass_SetDataToDxl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_data_to_dxl.Metaclass_SetDataToDxl_Event._TYPE_SUPPORT is None:
                _set_data_to_dxl.Metaclass_SetDataToDxl_Event.__import_type_support__()
...
class SetDataToDxl(metaclass=Metaclass_SetDataToDxl):
    ...
    from dynamixel_interfaces.srv._set_data_to_dxl import SetDataToDxl_Event as Event
